            ...
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.rent_chapter_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.rent_chapter_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                />
                {errors.rent_explain && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.rent_explain.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
            ...
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.packaging_level_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.packaging_level_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.packaging_chapter_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.packaging_chapter_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.packaging_explain && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.packaging_explain.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
            ...
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.collect_level_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.collect_level_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.collect_chapter_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.collect_chapter_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.collect_explain && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.collect_explain.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            ...
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.distribution_level_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.distribution_level_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.distribution_chapter_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>
                    {errors.distribution_chapter_code.message}
                  </FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.distribution_explain && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.distribution_explain.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
            ...
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.origin_level_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.origin_level_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.origin_chapter_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.origin_chapter_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.origin_explain && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.origin_explain.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
            ...
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.goal_level_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.goal_level_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.goal_chapter_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.goal_chapter_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                />
                {errors.goal_explain && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.goal_explain.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
            ...
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.discount_chapter_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.discount_chapter_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.discount_explain && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.discount_explain.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
            ...
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.maliat_level_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.maliat_level_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.maliat_chapter_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.maliat_chapter_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.maliat_explain && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.maliat_explain.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
            ...
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.avarez_level_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.avarez_level_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.avarez_chapter_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.avarez_chapter_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.avarez_explain && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.avarez_explain.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
            ...
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.insurance_level_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.insurance_level_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.insurance_chapter_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.insurance_chapter_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.insurance_explain && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.insurance_explain.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
            ...
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.other_level_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.other_level_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.other_chapter_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.other_chapter_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.other_explain && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.other_explain.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
            ...
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.rond_level_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.rond_level_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                {errors.rond_chapter_code && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.rond_chapter_code.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
            <Grid item md={3} lg={3} xl={3} sx={{ textAlign: 'center' }}>
              <FormControl fullWidth>
                ...
                />
                {errors.rond_explain && (
                  <FormHelperText sx={{ color: 'error.main' }}>{errors.rond_explain.message}</FormHelperText>
                )}
              </FormControl>
            </Grid>
