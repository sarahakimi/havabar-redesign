...
import { Card, CardContent, CardHeader, StepConnector, stepConnectorClasses } from '@mui/material'
    ...
    <Card container spacing={6}>
      <CardContent>
        ...
        {hasUser && (
          <>
            <Stepper
              activeStep={data.order.state_id - 1}
              alternativeLabel
                  ...
                  <CardContent>
                    <Grid container spacing={2}>
                      <Grid item xs={12} sm={12} md={6} lg={3} xl={3}>
                        <TextField label='شماره سفارش' value={data.order.id} dir='ltr' disabled fullWidth />
                      </Grid>

                      <Grid item xs={12} sm={12} md={6} lg={3} xl={3}>
                        <TextField label='وضعیت' value={data.order.state} disabled fullWidth />
                      </Grid>
                      <Grid item xs={12} sm={12} md={6} lg={3} xl={3}>
                        <TextField label='هزینه' value={data.order.price} disabled fullWidth />
                      </Grid>
                    </Grid>
                  </CardContent>
                </Card>
